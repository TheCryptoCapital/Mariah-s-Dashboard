...
# Use this wherever you set trade rules
...
if more_tab == "📡 Signal Scanner":
    with st.container():
        ...
        rsi_threshold = st.slider("RSI Oversold Threshold", 10, 50, 30)
        ...
        for symbol in symbols:
            ...
            try:
                rsi_data = check_rsi_signal(symbol=symbol, interval=interval, threshold=rsi_threshold)

                if rsi_data and rsi_data["trigger"]:
                    entry_price = rsi_data["price"]
                    stop_loss = entry_price * 0.98  # 2% SL below entry
